...
def test_get_booking_reference():
    r1 = requests.get("http://127.0.0.1:8082/booking_reference")
    r1.raise_for_status()
    ref1 = r1.text
    r2 = requests.get("http://127.0.0.1:8082/booking_reference")
    r2.raise_for_status()
    ref2 = r2.text
    assert ref1 != ref2
...
def test_get_data_for_train_no_such_train():
    requests.Client()
    response = requests.get("http://127.0.0.1:8081/data_for_train/no-such")
...
def test_get_data_for_existing_train():
    requests.Client()
    response = requests.get("http://127.0.0.1:8081/data_for_train/express_2000")
...
def test_reset_train():
    response = requests.post("http://127.0.0.1:8081/reset/express_2000")
...
def test_reserve_ok():
    ...
    response = requests.post("http://127.0.0.1:8081/reserve", json=payload)
...
def test_ticket_office():
    ...
    response = requests.post("http://127.0.0.1:8083/reserve", json=payload)
